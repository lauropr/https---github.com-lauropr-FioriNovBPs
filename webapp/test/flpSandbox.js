			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fiorinovbp-display": {
								"semanticObject": "fiorinovbp",
								"action": "display",
								"description": "Parceiros em modo freestyle",
								"title": "Parceiros",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fiorinov.bp",
									"url": sap.ui.require.toUrl("fiorinov/bp")
								}
							}
						}
					}
